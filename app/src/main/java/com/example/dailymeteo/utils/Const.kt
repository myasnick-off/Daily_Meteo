...
const val ARG_CITY = "ARG_CITY_FOR_DETAILS"
const val ARG_DAILY = "ARG_DAILY_WEATHER"

const val SEARCH_NO_RESULTS = 11
const val SEARCH_UNSUCCESSFUL = 22
const val SEARCH_FAILURE = 33